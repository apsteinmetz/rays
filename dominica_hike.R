# make dominica boiling lake hike from alltrains garmin gpx data
...
gpx_parsed <- htmlTreeParse(file = "data/Boiling_Lake_hike_route_edit.gpx", useInternalNodes = TRUE)
